...
obtainInstruction('steak', 0)
  ...
  .then ((step7)=>{
    ...
    //we skipped the step 8 as it's not shown in the expected result
...
// Bonus 2 - Promise all
const loopOverBrusselSteps = async ()=>{
  const promisesBrussels = []
  brusselsSprouts.forEach((eachStep, index) =>{
